...
If you are unsure how something should be implemented from the JS side, look at [WebView.android.js](https://github.com/SuperBigBang/react-native-webview/blob/master/js/WebView.android.js) in the React Native source.
